...
// deleteMovie handles the DELETE request to delete a specific movie by ID.
...
// getMovie handles the GET request to retrieve a specific movie by ID.
...
// updateMovie handles the PUT request to update an existing movie by ID.
